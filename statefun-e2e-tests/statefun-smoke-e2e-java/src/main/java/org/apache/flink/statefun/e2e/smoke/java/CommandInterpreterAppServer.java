...
public class CommandInterpreterAppServer {
  ...
  private static ChannelInitializer<Channel> getChannelInitializer(InputStream trustInputStream, InputStream certInputStream, InputStream keyInputStream) {
    return getTlsEnabledInitializer(SslContextBuilder.forServer(certInputStream, keyInputStream, A_SERVER_KEY_PASSWORD).trustManager(trustInputStream));
  }
